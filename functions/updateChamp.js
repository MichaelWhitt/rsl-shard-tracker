...
exports.handler = async (event) => {
    ...
    const {_id:id, name, rarity, affinity, type, faction, race, owned, rating, pullCount} = JSON.parse(event.body)
    const variables = {id, name, rarity, affinity, type, faction, race, owned, rating, pullCount}
    try {
