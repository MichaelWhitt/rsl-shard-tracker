...
const GameGrid = (props) => {
    ...
    return(
        <div style={{display: 'flex'}}>
            <div style={{width: 1000, height: 650, background: 'black', margin: '50px 0', borderRadius: 15}}>
            ...
            <div style={{width: 300, background: '#cc2f5c', borderRadius: 15, marginLeft: 100, height: 750}}>
